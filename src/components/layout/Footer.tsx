  ...
  return (
    <footer className="w-full bg-[#080d1a] text-gray-300 border-t border-gray-800/80 font-sans relative z-10 transition-colors">
      ...
      <div className="bg-gradient-to-r from-gray-900 via-slate-900 to-gray-900 border-b border-gray-800/80 py-8 px-4 sm:px-6 md:px-12">
        <div className="container mx-auto max-w-7xl grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="flex items-center gap-3.5 group">
            <div className="w-11 h-11 rounded-2xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-teal-400 shrink-0 group-hover:scale-110 transition-transform">
              <Truck className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-black text-white uppercase tracking-wider">Express Shipping</h4>
              <p className="text-[11px] text-gray-400 mt-0.5">Fast delivery &amp; real-time tracking</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 group">
            ...
            <div>
              <h4 className="text-xs font-black text-white uppercase tracking-wider">Easy 7-Day Returns</h4>
              <p className="text-[11px] text-gray-400 mt-0.5">Hassle-free instant exchanges</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 group">
            ...
            <div>
              <h4 className="text-xs font-black text-white uppercase tracking-wider">100% Secure Checkout</h4>
          ...
          <div className="flex items-center gap-3.5 group">
            ...
            <div>
              <h4 className="text-xs font-black text-white uppercase tracking-wider">Authentic Guarantee</h4>
              <p className="text-[11px] text-gray-400 mt-0.5">100% genuine luxury products</p>
            </div>
          </div>
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-4 pr-0 md:pr-6">
            <Link href="/" className="flex items-center gap-2 select-none w-max">
              ...
              <span className="font-black text-base tracking-wider text-white uppercase leading-none">FCI SELLER</span>
            </Link>
              ...
              <div className="flex items-center gap-2.5">
                {[
                  ...
                  <Link
                    ...
                    className="w-9 h-9 rounded-xl bg-slate-900 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-teal-400 hover:border-teal-500/50 hover:bg-teal-500/10 transition-all cursor-pointer"
                  >
                    {social.icon}
                  </Link>
                ))}
          ...
          <div className="border-b border-gray-800 md:border-none pb-4 md:pb-0">
            ...
            <ul className={`space-y-2.5 text-xs text-gray-400 font-medium transition-all ${
              ...
              <li><Link href="/products?category=Women" className="hover:text-teal-400 transition-colors">Women's Fashion</Link></li>
              <li><Link href="/products?category=Men" className="hover:text-teal-400 transition-colors">Men's Apparel</Link></li>
              <li><Link href="/products?category=Kids" className="hover:text-teal-400 transition-colors">Kids Wear</Link></li>
              <li><Link href="/products?category=Accessories" className="hover:text-teal-400 transition-colors">Beauty &amp; Accessories</Link></li>
              <li><Link href="/products?category=Footwear" className="hover:text-teal-400 transition-colors">Footwear Collection</Link></li>
              <li><Link href="/products?category=Collections" className="hover:text-teal-400 transition-colors">Curated Collections</Link></li>
              <li><Link href="/studio" className="hover:text-teal-400 transition-colors">Runway Studio Drops</Link></li>
            </ul>
          </div>
          ...
          <div className="border-b border-gray-800 md:border-none pb-4 md:pb-0">
            ...
            <ul className={`space-y-2.5 text-xs text-gray-400 font-medium transition-all ${
              ...
              <li><Link href="/orders" className="hover:text-teal-400 transition-colors">Track Order Package</Link></li>
              ...
              <li><Link href="/terms" className="hover:text-teal-400 transition-colors">Shipping Terms</Link></li>
          ...
          <div className="border-b border-gray-800 md:border-none pb-4 md:pb-0">
            ...
            <div className={`space-y-3 text-xs text-gray-400 transition-all ${
              ...
              <div className="space-y-2">
                <p><Link href="/about" className="hover:text-teal-400 transition-colors">About FCI SELLER</Link></p>
                <p><Link href="/privacy" className="hover:text-teal-400 transition-colors">Privacy Policy</Link></p>
                <p><Link href="/terms" className="hover:text-teal-400 transition-colors">Terms of Service</Link></p>
              </div>
        ...
        {/* ECOSYSTEM BADGES */}
        <div className="border-t border-gray-800/80 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          
          {/* Payment Badges */}
          <div>
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 block mb-2.5 text-center md:text-left">
          ...
          {/* Shipping Partners */}
          <div>
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 block mb-2.5 text-center md:text-right">
        ...
        <div className="border-t border-gray-800/80 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <p className="text-center sm:text-left">
            &copy; 2026 <span className="font-bold text-white uppercase">FCISELLER</span>. All Rights Reserved. Made with ❤️ in India.
          </p>
