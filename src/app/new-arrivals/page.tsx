      ...
      <div className="container mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">New Arrivals</h1>
          </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={viewMode === 'grid' ? 'bg-pink-600 text-white' : ''}
            >
            ...
            <Button
              ...
              className={viewMode === 'list' ? 'bg-pink-600 text-white' : ''}
            >
